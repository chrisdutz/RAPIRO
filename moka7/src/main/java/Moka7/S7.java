...
public class S7 {
    ...
    public static final int S7AreaPE            = 0x81; // Peripheral Inputs
    public static final int S7AreaPA            = 0x82; // Peripheral Outputs
    public static final int S7AreaMK            = 0x83; // Machine Code (???)
    public static final int S7AreaDB            = 0x84; // Data Blocks
    public static final int S7AreaCT            = 0x1C; // Counters
    public static final int S7AreaTM            = 0x1D; // Timers
    // Connection types
    public static final byte PG                 = 0x01; // Programming Console
    public static final byte OP                 = 0x02; // Siemens HMI panel
    public static final byte S7_BASIC           = 0x03; // Generic data transfer connection
    // Block type
    public static final int Block_OB            = 0x38; // Organization Block (Blocks for user programs based on different operating system events.)
    public static final int Block_DB            = 0x41; // Data Block (Memory storage areas for user data)
    public static final int Block_SDB           = 0x42; // System Data Block
    public static final int Block_FC            = 0x43; // Function Call	(Called progammed blocks)
    public static final int Block_SFC           = 0x44; // System Function Call (Integrated FC for CPU information)
    public static final int Block_FB            = 0x45; // Function Block (A function with it's own data block)
    public static final int Block_SFB           = 0x46; // System Function Block (Integrated FB for CPU information)
    // Sub Block Type
    ...
    // Block languages
    public static final int BlockLangAWL        = 0x01; // STL - instruction list
    public static final int BlockLangKOP        = 0x02; // LAD - ladder diagram
    public static final int BlockLangFUP        = 0x03; // FBD - function block diagram
    public static final int BlockLangSCL        = 0x04; // Structured Control Language
